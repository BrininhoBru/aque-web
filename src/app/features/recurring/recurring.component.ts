...
@Component({
  ...
  styles: [`
    ...
    .rc-card-desc { display: flex; align-items: center; gap: 0.375rem; flex: 1; min-width: 0; }
    ...
    .rc-card-amount { font-family: var(--font-mono); font-size: 14px; font-weight: 500; }
    .rc-card-actions { display: flex; gap: 4px; justify-content: flex-end; }
  `],
})
